...
//DOM-elements
const weatherDisplayEl = document.getElementById('weatherDisplay') as HTMLDivElement;
const forecastSection = document.getElementById('forecastSection') as HTMLDivElement;
...
const createForecast = (timeSeries: SMHIResponse['timeSeries']): ForecastDay[] => {
  const dailyData: { [key: string]: { temps: number[], symbols: number[], times: string[] } } = {};
